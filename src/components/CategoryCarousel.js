    ...
    <section className='my-6'>
        <div>
            ...
            <Swiper       
                ...
                1: {
                    ...
                    <SwiperSlide className="py-1" onClick={() => {handleCategory("velkomst"); handleQuery("theme.slug")}}>
                        <div>
                            <h3 className='text-base text-primaryGray-700 font-thin'>Velkomst</h3>
                        </div>
                    </SwiperSlide>

                    <SwiperSlide className="py-1" onClick={() => {handleCategory("middag"); handleQuery("theme.slug")}}>
                        <div>
                            <h3 className='text-base text-primaryGray-700 font-thin'>Middag</h3>
                        </div>
                    </SwiperSlide>

                    <SwiperSlide className="py-1" onClick={() => {handleCategory("hygge"); handleQuery("theme.slug")}}>
                        <div>
                            <h3 className='text-base text-primaryGray-700 font-thin'>Hygge</h3>
                        </div>
                    </SwiperSlide>

                    <SwiperSlide className="py-1" onClick={() => {handleCategory("fest"); handleQuery("theme.slug")}}>
                        <div>
                            <h3 className='text-base text-primaryGray-700 font-thin'>Fest</h3>
                        </div>
                    </SwiperSlide>

                    <SwiperSlide className="py-1" onClick={() => {handleCategory("romantik"); handleQuery("theme.slug")}}>
                        <div>
                            <h3 className='text-base text-primaryGray-700 font-thin'>Romantik</h3>
                        </div>
                    </SwiperSlide>

                    <SwiperSlide className="py-1" onClick={() => {handleCategory("afslapning"); handleQuery("theme.slug")}}>
                        <div>
                            <h3 className='text-base text-primaryGray-700 font-thin'>Afslapning</h3>
                        </div>
                    </SwiperSlide>
            </Swiper>
        </div>
                    ...
                    <div className="fadeInAnimation h-44 w-full mb-4 relative" key={id}>
                        ...
                        <div className='flex justify-between font-thin absolute items-start w-full px-5 py-4'>
                            <div className='flex gap-2 text-xs font-regular'>
                                <p className='bg-primaryBlack bg-opacity-50 px-4 py-1 rounded-xl uppercase'>{taste?.title}</p>
                                <p className='bg-primaryBlack bg-opacity-50 px-4 py-1 rounded-xl uppercase'>{liqour?.type}</p>
                            </div>
                        ...
                        >
                            <div className='px-2'>
                                <div className='flex flex-col gap-1'>
                                    ...
                                    <p className="line-clamp-1 text-sm font-regular text-primaryGray-500">{body}</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        {!layout && (
            <div className="px-5 mt-7 flex flex-wrap gap-4 justify-between">
                {events.map(({title, id, likes, image, body, time, taste, liqour}) =>
                    <div className="fadeInAnimation h-60 max-w-[46%] relative" key={id}>
                        <div className='flex justify-between font-thin absolute items-start w-full px-3 py-3'>
                            <div className='flex items-center gap-1'>
                                ...
                                <p className='text-xs shadow-primaryBlack'>
                                    {time} min
                                </p>
                            </div>
                            {user && <LikeCocktail id={id} likes={likes} />}
                        ...
                        >
                            <div>
                                <div className='flex flex-col gap-1'>
                                <div className='flex gap-2 text-xs font-regular'>
                                    <p className='border-[1px] px-4 py-1 rounded-xl uppercase'>{taste?.title}</p>
                                </div>
                
                                    <h3 className='text-base font-medium'>{title}</h3>
                                    <p className="line-clamp-1 text-xs font-regular text-primaryGray-500">{body}</p>
                                </div>
                            </div>
                        </div>
                    </div>
