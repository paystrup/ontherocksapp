...
export default function HeroSection() {
    ...
    return (
        <section className="hidden max-h-[100vh] w-full overflow-hidden mb-32 xl:flex">
            ...
            <div className="flex gap-40 items-center" ref={el}>
                <div className="flex flex-col gap-4 w-[50%]">      
                <h1 className="title gsapAnim text-6xl font-displayBook leading-tight">
                ...
                <p className="description gsapAnim text-xl leading-relaxed font-thin">
