...
export default function AgeConfirmed() {
  ...
  return (
    <div className='fixed top-0 left-0 w-full h-[100vh] scroll- z-[9999] bg-primaryBlack lg:bg-opacity-80 lg:backdrop-blur-sm lg:flex lg:justify-center lg:items-center fadeInAnimation'>
      <div className="age-confirm-modal h-full w-full flex flex-col lg:w-1/2 lg:h-1/2 lg:justify-center lg:rounded-3xl fadeInAnimation"                  
          style={{
              backgroundImage: `linear-gradient(180deg, rgba(0,0,0,0) 0%, rgba(0,0,0,1) 100%), url(${image})`,
