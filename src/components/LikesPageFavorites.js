                    ...
                    <section className="mb-7">
                        <div className="flex flex-wrap gap-4">
                            <div className="flex flex-col items-center justify-center gap-2">
                                ...
                                <h3 className="text-[11px] font-thin text-primaryGray-500">{t("likespage.categories.all")}</h3>
                            </div>

                            {/* ADD NEW CATEGORY */}
                            <div className="flex flex-col items-center justify-center gap-2">
                                <div 
                                    className="w-16 h-16 rounded-full bg-lightBlack flex items-center justify-center"
                                >
                                    <PlusIcon className="h-1/2 w-1/2 text-primaryGray-500" />                                
                                </div>
                                <h3 className="text-[11px] font-thin text-primaryGray-500">{t("likespage.categories.new")}</h3>
                            </div>
                        </div>
                    </section>
