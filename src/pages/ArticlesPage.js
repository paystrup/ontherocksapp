...
export default function ArticlesPage() {
  ...
  return (
    <div className="text-primaryWhite mt-16 mb-32 lg:flex lg:justify-between lg:px-14 lg:mt-48">
      {/* 🚨🚨🚨🚨🚨🚨 CHANGE 2OOvh WHEN IMAGES IS FETCH */}
      <div className="lg:w-[45vw] lg:h-[150vh] lg:relative">
        <div
      ...
      <div className="mt-14 px-5 lg:mt-0">
        ...
        <div className=" lg:w-[45vw]">
          ...
          <div className="section2 my-7">
            ...
            {article?.section2?.data && <h1>Billeder fra slugs</h1>}
          </div>
          ...
          <div className="section3 my-7">
            ...
            {article?.section3?.data && <h1>Billeder fra slugs</h1>}
          </div>
          ...
          <div className="section4 my-7">
            ...
            {article?.section4?.data && <h1>Billeder fra slugs</h1>}
          </div>
          ...
          <div className="section4 my-7">
            ...
            {article?.section5?.data && <h1>Billeder fra slugs</h1>}
          </div>
